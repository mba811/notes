...
在前边的安装简介中，我们提及到了基础镜像。在[前面的部分](http://www.widuu.com/archives/07/dockerizing.md)我们已经使用了Docker镜像，举例：`ubuntu`镜像和`training/webapp`镜像。
...
![](http://yun.widuu.com/wp-content/uploads/2014/07/login-web.png)
